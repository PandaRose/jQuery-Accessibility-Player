...
(function($, undefined) {
	...
	$.jPlayer.prototype = {
		...
		options: { // Instanced in $.jPlayer() constructor
			...
			muted: false,
			wmode: "transparent", // Default Flash wmode is: window.  Valid wmode: transparent, opaque, direct, gpu
		...
		_init: function() {
			...
			if(this.flash.used) {
				...
				if($.browser.msie && Number($.browser.version) <= 8) {
					...
					+ ' width="0" height="0" wmode="'+this.options.wmode+'" style="z-index: 0; position: absolute;">'
					+ '</object>';
